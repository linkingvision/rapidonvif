...
{
public:
	CRapidRTSPONVIF(std::string streamUrl, int transport, 
				std::string userName, std::string userPwd, 
				bool bEnableAudio);
	virtual ~CRapidRTSPONVIF();
public:
...
{
public:
	CRapidRTSPONVIFLive555(std::string streamUrl, int transport, 
				std::string userName, std::string userPwd, 
				bool bEnableAudio);
	~CRapidRTSPONVIFLive555();
public:
	virtual int start();
